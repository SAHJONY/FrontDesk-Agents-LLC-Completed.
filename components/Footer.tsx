      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-lg font-bold text-white mb-4">FrontDesk Agents</h3>
            <p className="text-slate-400 text-sm mb-4">
              AI-Powered Revenue Workforce for modern businesses.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://twitter.com/frontdeskagents" 
                target="_blank" 
              ...
              <a 
                href="https://linkedin.com/company/frontdeskagents" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-cyan-400 transition-colors"
              ...
              <a 
                href="https://facebook.com/frontdeskagents" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-cyan-400 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/integrations" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">
                  Integrations
                </Link>
              </li>
              <li>
                <Link href="/demo" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">
                  Request Demo
                </Link>
              </li>
            </ul>
