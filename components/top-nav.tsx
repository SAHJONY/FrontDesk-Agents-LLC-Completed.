    ...
    <header className="border-b border-slate-800 bg-slate-950/80">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 lg:px-8">
        ...
        <nav className="flex items-center gap-4 text-xs sm:text-sm text-slate-300">
          ...
          <Link href="/demo" className="hover:text-sky-400">Demo</Link>
          <Link href="/pricing" className="hover:text-sky-400">Pricing</Link>
          <Link href="/industries" className="hover:text-sky-400">Industries</Link>
          <Link href="/dashboard" className="hover:text-sky-400">Client Dashboard</Link>
          <Link href="/admin" className="hover:text-sky-400">Owner</Link>
