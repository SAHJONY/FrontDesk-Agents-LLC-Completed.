...
const HERO_IMAGES: Record<PageKey, HeroConfig> = {
  ...
  dashboard: {
    ...
    alt: "Executive view with real-time call and revenue metrics"
  },
  "dashboard-outbound": {
  ...
  "dashboard-retention": {
    ...
    alt: "Retention and rebook metrics dashboard"
  },
  admin: {
    src: "/images/premium/admin-control.jpg",
    alt: "Admin control center for tenants, phone numbers and agents"
  },
  "ai-agents": {
    src: "/images/premium/ai-agents-hero.jpg",
    alt: "Multi-agent AI receptionists working together for a business"
  }
};
