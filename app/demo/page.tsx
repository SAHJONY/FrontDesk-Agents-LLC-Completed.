    ...
    <div className="space-y-10">
      <section className="space-y-4">
        ...
        <h1 className="text-2xl font-bold text-slate-50 sm:text-3xl">
          See FrontDesk Agents working with your use case.
        </h1>
        <p className="max-w-2xl text-sm text-slate-300">
          We’ll connect your vertical (clinic, law firm, real estate, etc.),
          show you how the AI agent answers, follows up and pushes appointments
          straight into your CRM or calendar.
        </p>
      </section>
