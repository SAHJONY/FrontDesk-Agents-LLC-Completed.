...
// Step out 3 levels: [id] > calls > dashboard
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold flex items-center gap-3">
            ...
            Analysis: <span className="text-zinc-500">{callId}</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-zinc-900 rounded-lg border border-white/10">
            ...
            <p className="text-lg text-green-500 text-xs font-bold">READY</p>
          </div>
          <div className="p-4 bg-zinc-900 rounded-lg border border-white/10">
            <CheckCircle className="w-4 h-4 mb-2 text-green-500" />
            <p className="text-sm text-zinc-400">Compliance</p>
            <p className="text-lg text-green-500 text-xs font-bold">VERIFIED</p>
          </div>
        </div>
      </div>
    </div>
