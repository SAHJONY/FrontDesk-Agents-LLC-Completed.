// app/dashboard/operational-overview/page.tsx - ULTRA PREMIUM VERSION
              ...
              <div className="relative p-6">
                ...
                <div className="mt-4 flex items-end gap-1 h-8">
                  {kpi.sparkline.map((value, i) => (
                    <div 
                      key={i} 
                      className={`flex-1 bg-gradient-to-t from-${kpi.color}-500 to-${kpi.color}-400 rounded-t opacity-60 group-hover:opacity-100 transition-opacity`}
