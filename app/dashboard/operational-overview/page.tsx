// app/dashboard/operational-overview/page.tsx - ULTRA PREMIUM VERSION (LOCALIZED)
"use client";
...
// --- Simulated User Settings (for Localization) ---
...
export default function OperationalOverviewPage() {
  ...
  const kpis = [
    ...
    { 
      ...
      value: formatCurrency(45.2), // Localized Currency
      change: '+18%', 
      trend: 'up',
      icon: BanknotesIcon, 
      color: 'emerald',
      subtitle: `this month (${USER_CURRENCY})`,
  ...
  // Helper component to render KPI sparkline (simplified implementation for completeness)
  const Sparkline = ({ data, color }) => (
    <div className="mt-4 flex items-end gap-1 h-8">
      {data.map((value, i) => (
        <div 
          key={i} 
          className={`flex-1 bg-gradient-to-t from-${color}-500 to-${color}-400 rounded-t opacity-60 group-hover:opacity-100 transition-opacity`}
            ...
            >
              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className={`w-14 h-14 bg-gradient-to-br from-${kpi.color}-500 to-${kpi.color}-600 rounded-xl flex items-center justify-center shadow-lg`}>
