...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <header>
        <Image src={hero.src} alt={hero.alt} width={hero.width} height={hero.height} priority className="w-full h-64 object-cover rounded-b-xl" />
      </header>
      ...
      <section className="mx-auto max-w-4xl p-6">
        ...
        <Image src={banner.src} alt={banner.alt} width={banner.width ?? 1200} height={banner.height ?? 300} className="w-full rounded-lg" />
        {/* tarjetas de precios */}
      </section>
    </main>
  );
