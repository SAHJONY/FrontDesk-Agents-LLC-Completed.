        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <div className="flex items-center gap-3 text-brand-cyan mb-6">
              ...
              <span className="uppercase tracking-widest font-bold text-sm">Real Estate Sector</span>
            </div>
            <h1 className="text-6xl font-black italic uppercase mb-8 leading-tight">
              AI for <span className="text-brand-cyan">Property Managers</span>
            </h1>
            <p className="text-xl text-zinc-400 mb-10 leading-relaxed">
              Handle maintenance requests, leasing inquiries, and rent collection reminders automatically. Scale your portfolio without increasing headcount.
            </p>
            <div className="flex gap-4">
              <button className="fd-btn fd-btn-primary px-8 py-4">Deploy Property Node</button>
              <button className="fd-btn fd-btn-ghost px-8 py-4">ROI Calculator</button>
            </div>
          </div>
          <div className="relative aspect-video rounded-2xl overflow-hidden border border-white/10">
            <Image 
              src="/images/solution-property.jpg" 
              alt="Property Management AI" 
              fill 
