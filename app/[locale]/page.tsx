...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#010204] text-[#f8fafc] font-sans selection:bg-cyan-500/30 overflow-x-hidden">
      ...
      {/* --- INTELLIGENCE LAYER: Sovereign Logic --- */}
        ...
        <div className="container mx-auto px-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 relative h-[450px] rounded-[48px] border border-white/5 overflow-hidden group p-12 flex flex-col justify-between hover:border-white/20 transition-all">
                ...
                <div>
                  <h3 className="text-5xl font-black uppercase italic mb-4 text-white tracking-tighter">Linguistic Sovereignty</h3>
                  <p className="text-slate-400 max-w-md font-bold text-sm tracking-widest uppercase">Autonomous directionality mapping across global territories.</p>
                </div>
            </div>
